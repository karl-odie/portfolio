...
import type { Activity, ActivitySVGPoints } from '../models/index';
import {
  ActivityFromJSON,
  ActivityToJSON,
...
export class ActivitiesApi extends runtime.BaseAPI {
  /**
   */
  async activitiesGeoJsonRetrieveRaw(
    requestParameters: ActivitiesGeoJsonRetrieveRequest,
    ...
    const response = await this.request(
      {
        path: `/api/activities/{uuid}/geo_json/`.replace(
          `{${'uuid'}}`,
  ...
  /**
   */
  async activitiesGeoJsonRetrieve(
    requestParameters: ActivitiesGeoJsonRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Activity> {
    const response = await this.activitiesGeoJsonRetrieveRaw(
      requestParameters,
      initOverrides,
    );
  ...
  /**
   */
  async activitiesRetrieveRaw(
    requestParameters: ActivitiesRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Activity>> {
    if (requestParameters['uuid'] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/api/activities/{uuid}/`.replace(
          `{${'uuid'}}`,
          encodeURIComponent(String(requestParameters['uuid'])),
        ),
        method: 'GET',
  ...
  /**
   */
  async activitiesRetrieve(
    requestParameters: ActivitiesRetrieveRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Activity> {
    const response = await this.activitiesRetrieveRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  /**
   */
  async activitiesSvgListRaw(
    requestParameters: ActivitiesSvgListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ActivitySVGPoints>>> {
    if (requestParameters['uuid'] == null) {
      throw new runtime.RequiredError(
        'uuid',
    ...
    const response = await this.request(
      {
        path: `/api/activities/{uuid}/svg/`.replace(
          `{${'uuid'}}`,
          encodeURIComponent(String(requestParameters['uuid'])),
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(ActivitySVGPointsFromJSON),
    );
  }

  /**
   */
  async activitiesSvgList(
    requestParameters: ActivitiesSvgListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<ActivitySVGPoints>> {
    const response = await this.activitiesSvgListRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
