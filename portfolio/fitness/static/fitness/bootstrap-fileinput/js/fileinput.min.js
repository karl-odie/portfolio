    ...
    (t.prototype = {
      ...
      _init: function (t) {
        ...
        (o.options = t),
          ...
          (o.uploadFileAttr = i.isEmpty(l.attr('name'))
            ? 'file_data'
            : l.attr('name')),
          (n = o._getLayoutTemplate('progress')),
          (o.progressTemplate = n.replace('{class}', o.progressClass)),
          (o.progressCompleteTemplate = n.replace(
            '{class}',
            o.progressCompleteClass,
          )),
          (o.progressErrorTemplate = n.replace(
            '{class}',
            o.progressErrorClass,
          )),
          ...
          (o.isUploadable =
            i.hasFileUploadSupport() && !i.isEmpty(o.uploadUrl)),
          (o.isClickable =
            o.browseOnZoneClick &&
            o.showPreview &&
          ...
          (o.$caption = i.getElement(
            t,
            'elCaptionText',
            a.find('.file-caption-name'),
          )),
          ...
          i.isEmpty(o.msgErrorClass) ||
            i.addCss(o.$errorContainer, o.msgErrorClass),
      ...
      _initTemplateDefaults: function () {
        ...
        (t =
          ...
          (j = { width: '100%', height: '100%', 'min-height': '480px' }),
          (L.defaults = {
            layoutTemplates: {
              main1: t,
              main2: a,
            ...
            fileTypeSettings: {
              ...
              html: function (e, t) {
                return (
                  i.compare(e, 'text/html') || i.compare(t, /\.(htm|html)$/i)
                );
              },
              text: function (e, t) {
                return (
      ...
      _initPreviewCache: function () {
        ...
        (t.previewCache = {
          ...
          init: function () {
            ...
            e.length > 0 &&
              !i.isArray(e) &&
              (e = e.split(t.initialPreviewDelimiter)),
              (t.previewCache.data = {
                content: e,
          ...
          footer: function (e, a, n) {
            ...
            return (
              ...
              t._getLayoutTemplate('footer').setTokens({
      ...
      _errorsExist: function () {
        ...
        return t.$errorContainer.find('li').length
          ? !0
          : ((i = e(document.createElement('div')).html(
        ...
        var r = this,
          ...
          s =
            void 0 !== t.responseJSON && void 0 !== t.responseJSON.error
              ...
              : t.responseText;
        return (
          r.cancelling && r.msgUploadAborted && (o = r.msgUploadAborted),
          r.showAjaxErrorDetails && s
            ? ((s = e.trim(s.replace(/\n\s*\n/g, '\n'))),
              (s = s.length > 0 ? '<pre>' + s + '</pre>' : ''),
              (o += l + s))
            : (o += l),
          o === l && (o = r.msgAjaxError.replace('{operation}', i)),
          (r.cancelling = !1),
          n ? '<b>' + n + ': </b>' + o : o
        );
      },
      ...
      _initPreview: function (e) {
        ...
        return a.previewCache.count()
          ? ((t = a.previewCache.out()),
            ...
            a._initSortable(),
            void (
              i.isEmpty(t.content) || a.$container.removeClass('file-input-new')
            ))
      ...
      _getLayoutTemplate: function (e) {
        ...
        return i.isEmpty(t.customLayoutTags)
          ? a
          : i.replaceTags(a, t.customLayoutTags);
      },
      _getPreviewTemplate: function (e) {
        var t = this,
          a = t.previewTemplates[e];
        return i.isEmpty(t.customPreviewTags)
          ? a
          : i.replaceTags(a, t.customPreviewTags);
      },
      ...
      _getFrame: function (i) {
        ...
        return a.length
          ? a
          : (t._log('Invalid thumb frame with id: "' + i + '".'), null);
      },
      ...
      _getExtraData: function (e, i) {
        var t = this,
          a = t.uploadExtraData;
        return (
          'function' == typeof t.uploadExtraData &&
            (a = t.uploadExtraData(e, i)),
          a
        );
      },
      ...
      _uploadSingle: function (t, a, n) {
        var r,
          ...
          v,
          h = this,
          g = h.getFileStack().length,
          w = new FormData(),
          _ = h.previewInitId + '-' + t,
          b = h.filestack.length > 0 || !e.isEmptyObject(h.uploadExtraData),
          C = e('#' + _).find('.file-thumb-progress'),
          y = { id: _, index: t },
          T = !i.isEmpty(h.$element.attr('multiple'));
        (h.formdata = w),
          h.showPreview &&
            ((o = e('#' + _ + ':not(.file-preview-initial)')),
          ...
          0 === g ||
            ...
            h._abort(y) ||
            ((m = function (e, i) {
              (!T && v) || h.updateStack(e, void 0),
                h.uploadLog.push(i),
                h._checkAsyncComplete() && (h.fileBatchCompleted = !0);
            }),
            (l = function () {
              var e,
                t,
                ...
                n = h.uploadCache,
                r = 0,
                o = h.cacheInitialPreview;
              h.fileBatchCompleted &&
                ...
                setTimeout(function () {
                  ...
                  if (h.showPreview) {
                    if (
                      ...
                      (h.initialPreview = i.cleanArray(o.content)),
                        (h.initialPreviewConfig = i.cleanArray(o.config)),
                        (h.initialPreviewThumbTags = i.cleanArray(o.tags));
                    } else
                      (h.initialPreview = n.content),
                        (h.initialPreviewConfig = n.config),
                        (h.initialPreviewThumbTags = n.tags);
                    (h.cacheInitialPreview = {}),
                      h.hasInitData &&
                        (h._initPreview(), h._initPreviewActions());
                  }
                  h.unlock(l),
                    l && h._clearFileInput(),
                    (e = h.$preview.find('.file-preview-initial')),
                    h.uploadAsync &&
                      e.length &&
                      (i.addCss(e, i.SORT_CSS), h._initSortable()),
                    h._raise('filebatchuploadcomplete', [
                      h.filestack,
                      h._getExtraData(),
                    ]),
                    (h.uploadCount = 0),
            ...
            (c = function (a) {
              (r = h._getOutData(a)),
                (h.fileBatchCompleted = !1),
                h.showPreview &&
                  (o.hasClass('file-preview-success') ||
                    (h._setThumbStatus(o, 'Loading'),
                    i.addCss(o, 'file-uploading')),
                  s.attr('disabled', !0),
                  d.attr('disabled', !0)),
                n || h.lock(),
                h._raise('filepreupload', [r, _, t]),
                e.extend(!0, y, r),
                h._abort(y) && (a.abort(), h._setProgressCancelled());
            }),
            (u = function (a, l, d) {
              ...
              (r = h._getOutData(d, a)),
                e.extend(!0, y, r),
                setTimeout(function () {
                  i.isEmpty(a) || i.isEmpty(a.error)
                    ? (h.showPreview &&
                        (h._setThumbStatus(o, 'Success'),
                        s.hide(),
                        h._initUploadSuccess(a, o, n),
                        h._setProgress(101, C)),
                      h._raise('fileuploaded', [r, c, t]),
                      n ? m(t, c) : h.updateStack(t, void 0))
                    : ((v = !0),
                      h._showUploadError(a.error, y),
                      h._setPreviewError(o, t, T ? null : h.filestack[t]),
                      n && m(t, c));
                }, 100);
            }),
            (p = function () {
              setTimeout(function () {
                h.showPreview &&
                  ...
                  n ? l() : (h.unlock(!1), h._clearFileInput()),
                  h._initSuccessThumbs();
              }, 100);
            }),
            (f = function (i, r, l) {
              var s = h.ajaxOperations.uploadThumb,
                d = h._parseError(s, i, l, n ? a[t].name : null);
              (v = !0),
                setTimeout(function () {
                  n && m(t, _),
                    (h.uploadStatus[_] = 100),
                    h._setPreviewError(o, t, T ? null : h.filestack[t]),
                    e.extend(!0, y, h._getOutData(i)),
                    h._setProgress(
                      101,
                      C,
                      h.msgAjaxProgressError.replace('{operation}', s),
                    ),
                    h._showUploadError(d, y);
                }, 100);
            }),
            w.append(h.uploadFileAttr, a[t], h.filenames[t]),
            w.append('file_id', t),
            h._ajaxSubmit(c, u, p, f, _, t));
      },
      ...
      _deleteFileIndex: function (t) {
        ...
        'init_' === n.substring(0, 5) &&
          ...
          (a.initialPreviewThumbTags = i.spliceArray(
          ...
          t.getFrames(' .kv-file-upload').each(function () {
            ...
            t._handler(a, 'click', function () {
              ...
              e.hasClass('file-preview-error') ||
                t._uploadSingle(n, t.filestack, !1);
            });
          }));
      },
                      ...
                      return i.isEmpty(e) || i.isEmpty(e.error)
                        ? ((v = parseInt(
                          ...
                          void f.fadeOut('slow', function () {
                            i.cleanZoomCache(a.find('#zoom-' + f.attr('id'))),
                              t._clearObjects(f),
                              f.remove(),
                              o(),
                              d ||
      ...
      _readFiles: function (t) {
        ...
        (n.loadedImages = []),
          ...
          (a = function (e) {
            ...
            if (
              (i.isEmpty(w) ||
                (L = new RegExp('\\.(' + w.join('|') + ')$', 'i')),
              (x = j.toFixed(2)),
              n.maxFileSize > 0 && j > n.maxFileSize)
            )
              return (
            ...
            if (null !== n.minFileSize && j <= i.getNum(n.minFileSize))
              return (
            ...
            if (!i.isEmpty(h) && i.isArray(h)) {
              ...
              if (0 === R)
                return (
                  (S = n.msgInvalidFileType.setTokens({ name: B, types: Z })),
                  void (n.isError = y(S, U, D, e))
                );
            }
            return 0 !== R ||
      ...
      _setFileDropZoneTitle: function () {
        var e,
          ...
          n = t.dropZoneTitle;
        t.isClickable &&
          ((e = i.isEmpty(t.$element.attr('multiple'))
            ? t.fileSingle
            : t.filePlural),
          ...
          t.isUploadable &&
            ...
            (0 === a.find(i.FRAMES).length &&
              ...
              a.prepend(
                '<div class="' + t.dropZoneTitleClass + '">' + n + '</div>',
              ),
      ...
      _setPreviewError: function (e, i, t) {
        ...
        void 0 !== i && a.updateStack(i, t),
          a.removeFromPreviewOnError
            ? e.remove()
            : a._setThumbStatus(e, 'Error');
      },
      ...
      _getResizedImage: function (t, a, n) {
        ...
        try {
          C.drawImage(f, 0, 0, m, v),
            ...
            F &&
              ((u = window.piexif.dump(F)), (s = window.piexif.insert(u, s))),
            (r = i.dataURI2Blob(s)),
            (p.filestack[E] = r),
      ...
      _renderFileActions: function (e, i, t, a, n, r, o, l) {
        ...
        return (
          i &&
            (p = d._getLayoutTemplate('actionDelete').setTokens({
              removeClass: _,
          ...
          e &&
            (f = d._getLayoutTemplate('actionUpload').setTokens({
              uploadClass: g.uploadClass,
              uploadIcon: g.uploadIcon,
              uploadTitle: g.uploadTitle,
            })),
          t &&
            (m = d._getLayoutTemplate('actionZoom').setTokens({
          ...
          a &&
            ...
            (v = d._getLayoutTemplate('actionDrag').setTokens({
              dragClass: s,
      ...
      _change: function (t) {
        ...
        var r,
          ...
          w = function (i, t, n, r) {
            ...
            return a.isUploadable
              ? a._showUploadError(i, o)
              : a._showError(i, l);
          };
        if (
          ((a.reader = null),
        ...
        if (
          ...
          (s = d.length),
          (o = a._getFileCount(
            a.isUploadable ? a.getFileStack().length + s : s,
          )),
        ...
        return (
          ...
          i.required && !i.getFilesCount()
            ? (i.$errorContainer.html(''),
              i._showUploadError(i.msgFileRequired),
              !1)
      ...
      lock: function () {
        ...
        return (
          ...
          e.disable(),
          e.showRemove &&
            i.addCss(e.$container.find('.fileinput-remove'), 'hide'),
          e.showCancel &&
      ...
      unlock: function (e) {
        ...
        return (
          ...
          t.enable(),
          t.showCancel &&
            i.addCss(t.$container.find('.fileinput-cancel'), 'hide'),
          t.showRemove &&
            t.$container.find('.fileinput-remove').removeClass('hide'),
          e && t._resetFileStack(),
      ...
      upload: function () {
        ...
        if (r.isUploadable && !r.isDisabled && r._isFileSelectionValid(o)) {
          ...
          for (
            ...
            void 0 !== r.filestack[t] && r._uploadSingle(t, r.filestack, !0);
        }
      },
      destroy: function () {
        var i = this,
